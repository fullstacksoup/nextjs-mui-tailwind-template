...
const navigation = [
  ...
  { name: 'Sign In', href: '/signin', icon: <LoginIcon/>, current: false },
  { name: 'Forms', href: '/forms', icon: <DynamicFormIcon/>, current: false },
        ...
        <IconButton
          ...
          <Box sx={{ flexGrow: 1 }} />
            ...
            <Tooltip
                ...
                title={
                  <>
                    <Typography color="inherit"><b>Shopping Cart</b></Typography>
                    {'Go to chopping cart'}
                  </>
                }>
              <IconButton color="inherit" component={Link} href="/auth/comments" sx={{ml: 2}}><ShoppingCartIcon/></IconButton>                  
            </Tooltip> 
